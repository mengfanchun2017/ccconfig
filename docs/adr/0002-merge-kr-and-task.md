...
> **Status**: ✅ Accepted
> **日期**: 2026-06-08
> **关联**: [task_plan.md（待更新）](../task_plan.md), [Phase 0 安全 + 公开化](../task_plan.md)
> **Supersedes**: (无)
> **Superseded by**: (无)
> **模板**: MADR 4.0 极简版
...
4. **6 表嫌多**：f-logme 5 层架构再加 Tasks 表变 6 层，违反"简化"初衷
...
- **D3 f-logme 兼容**：不破坏现有 5 层架构（O/KR/Worklog/Reflect/SUM）
...
详见 [task_plan.md（Phase 0 任务 #14-#15 + 合并任务）](../task_plan.md)
...
- 飞书 Base 不能删表，Tasks 表 (`tblnSeKT2LiPUndd`) 保留为空 placeholder
