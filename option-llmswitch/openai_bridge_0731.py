#!/usr/bin/env python3
"""option-llmswitch OpenAI bridge 0731 版 — 专用 DeepSeek-V4-Flash-0731。

与原版差别：usage-only message_delta 加了 delta:{}，修复 Claude Code 2.1.228 报
rn.delta.stop_details undefined。

Usage:
    python3 openai_bridge_0731.py --port 8897 --upstream https://upstream/v1 \
        --upstream-key sk-xxx --upstream-model DeepSeek-V4-Flash-0731
"""
import argparse
import json
import os
