...
```bash
python3 $HOME/git/_ext/ppt-master/skills/ppt-master/scripts/source_to_md/pdf_to_md.py input.pdf -o output.md
```
...
```bash
python3 $HOME/git/ccconfig/link/skills/f-pdf/references/extract-images.py input.pdf ./output_dir/
```
...
- `$HOME/git/_ext/ppt-master/skills/ppt-master/scripts/source_to_md/pdf_to_md.py` — 完整 PDF→MD 转换
