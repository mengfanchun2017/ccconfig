...
| 阶段 | 时间 | 主题 | 状态 | 详细计划 |
|---|---|---|---|---|
| Phase 0 | 2026-06 上 | 安全 + 公开化（.gitignore / ccprivate 拆分 / filter-repo / pre-commit）| 🚧 收尾 (6/10) | [task_plan.md](docs/task_plan.md) |
| **Phase 0 末** | 2026-06 下 | **抽 f-ship skill 雏形 v0.1**（基于 ccconfig 4 层结构）| ⏳ 排队 | (Phase 0 末执行) |
| Phase 1 | 2026-06 下 | CI/CD + 测试 + lint 基础 | ⏳ 未开始 | (Phase 0 末后建) |
| Phase 2 | 2026-07 上 | 文档/ADR/发布流程 + **完善 f-ship skill v0.2** | ⏳ 未开始 | (同上) |
