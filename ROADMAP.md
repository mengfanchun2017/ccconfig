...
| 阶段 | 时间 | 主题 | 状态 | 详细计划 |
|---|---|---|---|---|
| Phase 0 | 2026-06 上 | 安全 + 公开化（.gitignore / ccprivate 拆分 / filter-repo / pre-commit）| ✅ 完成 | [task_plan.md](.github/task_plan.md) |
| Phase 1 | 2026-07 上 | 架构审核 + 三仓库文档补齐 + 产品化发布 | ✅ 完成 | (CI workflow 已加) |
| Phase 2 | 2026-07 中 | 文档/ADR/发布流程 + **完善 f-ship skill v0.2** + **Cloudflare Pages 产品站** | 🚧 进行中 | |
| Phase 3 | 2026-07 下 | 社区健康 + 后续迭代 | ⏳ 未开始 | |

## 阶段详情的滚动指针

**当前 active phase**：[.github/task_plan.md](.github/task_plan.md)

完成后：
1. `.github/task_plan.md` 顶部更新为 ✅ done
...
3. 读 .github/task_plan.md     ← 找「下次 session 入口」
